...
<body background="./image/bg.png" style="background-repeat:no-repeat ;background-size:100% 100%; background-attachment: fixed;" >
  <form action="check.php" method="GET">
    <div>
      ...
      <p style="font-family:arial;color:white;font-size:20px;text-align:center;font-family:KaiTi;">I store flag in my account，you will not find it! 2333</p>
  ...
  <div style="position: absolute;bottom: 0;width: 99%;"><p align="center" style="font:italic 15px Georgia,serif;color:white;">admin</p></div>   
</body>
</html>